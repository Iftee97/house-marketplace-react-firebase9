...
const EditListing = () => {
  ...
  // redirect if listing doesn't belong to user
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const fetchListing = async () => {
      const docRef = doc(db, 'listings', params.listingId) // create ref

      const docSnap = await getDoc(docRef) // get doc snapshot
  ...
  // sets userRef (user.uid) to logged in user
  useEffect(() => {
